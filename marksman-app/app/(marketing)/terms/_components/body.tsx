    ...
    <>
      ...
      <div className="mt-4 space-y-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <p className="text-muted-foreground font-bold text-sm leading-6">
            Welcome to Marksman&apos;s Terms of Service! These terms govern your
            use of our website and services, so please read them carefully. By
            accessing or using our website and services, you agree to be bound
            by these terms. If you do not agree with any part of the terms, then
